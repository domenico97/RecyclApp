...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (primoAccesso) {
            ...
            utenti.add(new Utente("Laura", "Bianchi", "LRTBNC88L17D789F", "laura.bianchi@gmail.com", "via Pendino Fisciano", "laura93", "3274552852", "cittadino"));
            utenti.add(new Utente("Domenico", "Trotta", "VLLGLI79A41H703C", "domenico.trotta@live.it", "via Maurizio Fisciano", "dom1997", "3894552124", "cittadino"));
