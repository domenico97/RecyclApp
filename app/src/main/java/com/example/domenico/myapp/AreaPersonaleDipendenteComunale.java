...
public class AreaPersonaleDipendenteComunale extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.area_personale_dipendente_comunale);
        ...
        bottomNavigationView.setSelectedItemId(R.id.area_personale_dipendente_comunale);
